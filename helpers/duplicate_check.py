...
def user_record_upload(userid, filename, file_hash, namespace,uploaded_at):
    return uploads_collection.insert_one({"userid":userid, "filename": filename, "file_hash": file_hash,"namespace":namespace,"uploaded_at":uploaded_at})